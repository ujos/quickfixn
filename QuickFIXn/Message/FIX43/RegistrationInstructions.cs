...
namespace QuickFix
{
    namespace FIX43 
    {
        public class RegistrationInstructions : Message
        {
            ...
            public RegistrationInstructions(RegistrationInstructions other) : base(other)
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("o"));
            }

            public new RegistrationInstructions Clone()
            {
                return (RegistrationInstructions)DoClone();
            }

            protected override QuickFix.Message DoClone()
            {
                return new RegistrationInstructions(this);
            }
            ...
            public class NoRegistDtlsGroup : Group
            {
                ...
                { 
                    get 
                    {
                        QuickFix.Fields.RegistDetls val = new QuickFix.Fields.RegistDetls();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    return IsSetField(Tags.RegistDetls);
                }
