...
namespace QuickFix
{
    namespace FIX50 
    {
        public class SecurityDefinitionRequest : Message
        {
            ...
            public SecurityDefinitionRequest(SecurityDefinitionRequest other) : base(other)
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("c"));
            }

            public new SecurityDefinitionRequest Clone()
            {
                return (SecurityDefinitionRequest)DoClone();
            }
            ...
            {
                public static int[] fieldOrder = {Tags.LegOptionRatio, Tags.LegPrice, 0};
            
                public SubscriptionRequestTypeGroup() 
                  :base( Tags.SubscriptionRequestType, Tags.LegOptionRatio, fieldOrder)
                {
                }
