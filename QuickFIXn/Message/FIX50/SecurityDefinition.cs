...
namespace QuickFix
{
    namespace FIX50 
    {
        public class SecurityDefinition : Message
        {
            ...
            public SecurityDefinition(SecurityDefinition other) : base(other)
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("d"));
            }

            public new SecurityDefinition Clone()
            {
                return (SecurityDefinition)DoClone();
            }
            ...
            public class ClearingBusinessDateGroup : Group
            {
                ...
                public ClearingBusinessDateGroup() 
                  :base( Tags.ClearingBusinessDate, Tags.LegOptionRatio, fieldOrder)
                {
                }
